...
class EventService {
  ...
  static const ADD_URL = "http://192.168.1.72/pcps_ans_api/api/EventCreate.php";
  static const VIEW_URL = "http://192.168.1.72/pcps_ans_api/api/EventRead.php";
  static const UPDATE_URL =
      "http://192.168.1.72/pcps_ans_api/api/EventUpdate.php";
  static const DELETE_URL =
      "http://192.168.1.72/pcps_ans_api/api/EventDelete.php";
