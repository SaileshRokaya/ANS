...
class LeaveService {
  static const ADD_URL =
      "http://192.168.1.72/pcps_ans_api/api/LeaveReqCreate.php";
  static const VIEW_URL =
      "http://192.168.1.72/pcps_ans_api/api/LeaveReqRead.php";
  static const UPDATE_URL =
      "http://192.168.1.72/pcps_ans_api/api/LeaveReqUpdate.php";
  static const DELETE_URL =
      "http://192.168.1.72/pcps_ans_api/api/LeaveReqDelete.php";
