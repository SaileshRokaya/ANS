...
class AttendanceService {
  static const readURL = "http://studentapi.patancollege.edu.np/api/attendance";
...
// Create a method eventFromJson which accept one parameter as a string
  ...
  Future<List> getAttendanceData() async {
    String? token;
    ...
    if (response.statusCode == 200) {
      ...
      Map<String, dynamic> attendanceList = jsonDecode(response.body);
      print(attendanceList);

      List<dynamic> receipt = attendanceList['data'];
