...
import 'package:ans/admin/admin_fee_information.dart';
import 'package:ans/admin/admin_leave_information.dart';
...
class AdminFeePage extends StatefulWidget {
  ...
  @override
  State<AdminFeePage> createState() => _AdminFeePageState();
}
