...
class AdminFeesRejectPage extends StatefulWidget {
  const AdminFeesRejectPage({Key? key}) : super(key: key);

  @override
  State<AdminFeesRejectPage> createState() => _AdminFeesRejectPageState();
}

class _AdminFeesRejectPageState extends State<AdminFeesRejectPage> {
