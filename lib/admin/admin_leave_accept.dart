...
class AdminLeaveAcceptPage extends StatefulWidget {
  const AdminLeaveAcceptPage({Key? key}) : super(key: key);

  @override
  State<AdminLeaveAcceptPage> createState() => _AdminLeaveAcceptPageState();
}

class _AdminLeaveAcceptPageState extends State<AdminLeaveAcceptPage> {
